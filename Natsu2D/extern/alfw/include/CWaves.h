...
public:
	...
	WAVERESULT LoadWaveFile(LPCTSTR szFilename, WAVEID *WaveID);
	WAVERESULT OpenWaveFile(LPCTSTR szFilename, WAVEID *WaveID);
	WAVERESULT LoadWaveFileImage(const void* pData, DWORD dwLength, WAVEID *WaveID);
...
private:
	WAVERESULT ParseFile(LPCTSTR szFilename, LPWAVEFILEINFO pWaveInfo);
	WAVERESULT ParseData(const void* pData, DWORD dwLength, LPWAVEFILEINFO pWaveInfo);
