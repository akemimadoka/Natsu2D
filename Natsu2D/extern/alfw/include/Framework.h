...
ALboolean ALFWLoadWaveToBuffer(LPCTSTR szWaveFile, ALuint uiBufferID, ALenum eXRAMBufferMode = 0);
ALboolean ALFWLoadWaveBufferToBuffer(void* pWaveBuffer, DWORD dwLength, ALuint uiBufferID, ALenum eXRAMBufferMode = 0);
